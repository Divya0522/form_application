 const selected = document.querySelector("#selected");
    ...
    function displayContent(ele) {
      ...
      if (ele === "Short Answer") {
        ...
        inputContainer.innerHTML = `<input type='number' max=${max} min=${min} placeholder="Enter number among ${min} [poor] and ${max} [Excellent]">`;
      } else if (ele == "Date") {
    ...
    function editElement() {
      alert("Edit the existing element is clicked");
    }
    ...
    function save() {
      ...
      localStorage.setItem('surveyQuestions', form.innerHTML);
